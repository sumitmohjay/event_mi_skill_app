...
class _HomePageState extends State<HomePage> {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color(0xFF8B5CF6), // Purple matching second image
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Header with profile - only icons, no "Events" title
          Row(
  ...
  Widget _buildLocationCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFEC4899), Color(0xFFF472B6)], // Pink gradient matching second image
